...
const A1 = C.cyan, A2 = C.violet, A3 = C.gray;
const BANNER = `
  ${A1}${B}████████████████████████████████████████████████████████████████${R}
  ${A1}${B}██${R}  ${D}┌──────────────────────────────────────────────────────┐${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}│${R}  ${A2}${B}██${R}${B} >_ ${R}${A2}${B}██${R}                                            ${D}│${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}│${R}  ${A1}${B}████████  ██████  ██    ██ ████████  ${D}│${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}│${R}  ${A1}${B}██       ██    ██ ██    ██    ██     ${D}│${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}│${R}  ${A1}${B}████     ████████ ██    ██    ██     ${D}│${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}│${R}  ${A1}${B}██       ██    ██ ██    ██    ██     ${D}│${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}│${R}  ${A1}${B}████████ ██    ██  ██████     ██     ${D}│${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}│${R}                                               ${D}│${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}│${R}  ${D}▌${R}${A2}${B} @TiantianYZJ ${R}                                    ${D}│${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}│${R}  ${D}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${R}  ${D}│${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}│${R}  ${A3}OpenBCI  ›  WebSocket Bridge  ›  EEG Real-time Stream${R}  ${D}│${R}  ${A1}${B}██${R}
  ${A1}${B}██${R}  ${D}└──────────────────────────────────────────────────────┘${R}  ${A1}${B}██${R}
  ${A1}${B}████████████████████████████████████████████████████████████████${R}
`;
