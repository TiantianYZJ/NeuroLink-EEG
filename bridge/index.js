...
const P1 = C.pink, P2 = C.violet, P3 = C.cyan;
const BANNER = `
  ${P1}${B}████████████████████████████████████████████████████████████████${R}
  ${P1}${B}██${R}  ${D}┌──────────────────────────────────────────────────────┐${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}│${R}  ${P3}${B}██${R}${B} >_ ${R}${P3}${B}██${R}                                            ${D}│${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}│${R}  ${P1}${B}████████  ██████  ██    ██ ████████ ████████  ${D}│${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}│${R}  ${P1}${B}   ██    ██    ██ ██    ██    ██       ██     ${D}│${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}│${R}  ${P1}${B}   ██    ████████ ████████    ██       ██     ${D}│${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}│${R}  ${P1}${B}   ██    ██    ██ ██    ██    ██       ██     ${D}│${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}│${R}  ${P1}${B}   ██    ██    ██ ██    ██ ████████   ██     ${D}│${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}│${R}                                               ${D}│${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}│${R}  ${P2}${B}▌${R}${P2}${B} @TiantianYZJ ${R}                                    ${D}│${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}│${R}  ${D}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${R}  ${D}│${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}│${R}  ${C.gray}OpenBCI  ›  WebSocket Bridge  ›  EEG Real-time Stream${R}  ${D}│${R}  ${P1}${B}██${R}
  ${P1}${B}██${R}  ${D}└──────────────────────────────────────────────────────┘${R}  ${P1}${B}██${R}
  ${P1}${B}████████████████████████████████████████████████████████████████${R}
`;
